...
`define NUM_CORE_WORKER 3
`define NUM_CORE_SYSTEM 3
`define NUM_CORE_PHYSICAL 4
`define NUM_CORECLUSTER 1
`define NUM_LOCK_USER 1
`define NUM_LOCK_SYSTEM 4
`define NUM_BARRIER_USER 1
`define NUM_BARRIER_SYSTEM 0
`define NUM_AUTO_ID 1
`define NUM_GLOBAL_TAG 1
...
//`define INCLUDE_OFFCHIP_MRAM
//`define INCLUDE_OFFCHIP_MRAM_OPT
`define INCLUDE_DDR
...
`define NUM_OFFCHIP_MRAM_PROFILER 8
`define BW_OFFCHIP_MRAM_PROFILER 64
`define FIXED_CACHEABLE_START (32'h 00000000)
`define FIXED_CACHEABLE_LAST (32'h bfffffff)
`define PLATFORM_NAME "arx_npu_mc"
`define INCLUDE_RVC_ROCKET_OPT
...
`define LOCK_INDEX_FOR_SYSTEM_VARIABLE 1
`define LOCK_INDEX_FOR_SYSTEM_HW 2
`define LOCK_INDEX_FOR_PRINTF 3
`define LOCK_INDEX_FOR_SW_BARRIER 4
`define NUM_LOCK 5
...
`define INCLUDE_OFFCHIP_MRAM_PROFILER
//`define NOT_INCLUDE_OFFCHIP_MRAM_PROFILER
`define INCLUDE_CORE
