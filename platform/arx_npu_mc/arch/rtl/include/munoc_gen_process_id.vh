...
begin
	...
	case(master_nodeid)
		...
		`NODE_ID_I_MNIM_I_SUB_CORE_002_NO_NAME:
		begin
			process_id_temp = `PROCESS_ID_I_MNIM_I_SUB_CORE_002_NO_NAME;
			process_id_onehot_temp[`PROCESS_ID_I_MNIM_I_SUB_CORE_002_NO_NAME] = 1'b 1;
			valid_access = 1;
		end
		`NODE_ID_I_MNIM_I_SUB_CORE_003_NO_NAME:
		begin
			process_id_temp = `PROCESS_ID_I_MNIM_I_SUB_CORE_003_NO_NAME;
			process_id_onehot_temp[`PROCESS_ID_I_MNIM_I_SUB_CORE_003_NO_NAME] = 1'b 1;
			valid_access = 1;
		end
	endcase
end