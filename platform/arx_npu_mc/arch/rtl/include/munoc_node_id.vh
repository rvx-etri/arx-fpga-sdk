...
`define NODE_ID_I_MNIM_I_MAIN_CORE_NO_NAME (6)
`define NODE_ID_I_MNIM_I_SUB_CORE_001_NO_NAME (7)
`define NODE_ID_I_MNIM_I_SUB_CORE_002_NO_NAME (8)
`define NODE_ID_I_MNIM_I_SUB_CORE_003_NO_NAME (9)
...
`define NODE_ID_I_SNIM_I_DCA_MATRIX_MAC00_CONTROL_MMIOX1_INTERFACE_MMIO (4)
`define NODE_ID_I_MNIM_PLATFORM_CONTROLLER_MASTER (10)
...
`define NODE_ID_I_MNIM_I_DCA_MATRIX_MAC00_MA_MLSU_NOC_PART (3)
`define NODE_ID_I_MNIM_I_DCA_MATRIX_MAC00_MB_MLSU_NOC_PART (4)
`define NODE_ID_I_MNIM_I_DCA_MATRIX_MAC00_MC_MLSU_NOC_PART (5)
